...
from pymdu.physics.solar.solweig.SOLWEIGpython.Lside_veg_v2015a import Lside_veg_v2015a
from pymdu.physics.solar.solweig.SOLWEIGpython.Kside_veg_v2019a import Kside_veg_v2019a
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.Perez_v3 import Perez_v3


def Solweig_2021a_calc(
    i,
    dsm,
    scale,
    rows,
    ...
    if altitude > 0:  # # # # # # DAYTIME # # # # # #
        ...
        if ani == 1:
            ...
            lv = Perez_v3(
                zenDeg, azimuth, radD, radI, jday, patchchoice
            )  # Relative luminance
        ...
        Tgwall = Tgampwall * np.sin(
            ...
            * np.pi
            / 2
        ) + (Tstart_wall)  # 2015a, based on max sun altitude
    ...
    # # # # Lside # # # #
    Least, Lsouth, Lwest, Lnorth = Lside_veg_v2015a(
        svfS,
        svfW,
        svfN,
        svfE,

...
import numpy as np
from pymdu.physics.solar.solweig.SOLWEIGpython.daylen import daylen
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.clearnessindex_2013b import (
    clearnessindex_2013b,
)
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.diffusefraction import (
    diffusefraction,
)
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.shadowingfunction_wallheight_13 import (
    shadowingfunction_wallheight_13,
)
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.shadowingfunction_wallheight_23 import (
    shadowingfunction_wallheight_23,
)
from pymdu.physics.solar.solweig.SOLWEIGpython.gvf_2018a import gvf_2018a
from pymdu.physics.solar.solweig.SOLWEIGpython.cylindric_wedge import cylindric_wedge
from pymdu.physics.solar.solweig.SOLWEIGpython.TsWaveDelay_2015a import (
    TsWaveDelay_2015a,
)
from pymdu.physics.solar.solweig.SOLWEIGpython.Kup_veg_2015a import Kup_veg_2015a

# from .Lside_veg_v2015a import Lside_veg_v2015aF
# from .Kside_veg_v2019a import Kside_veg_v2019a
from pymdu.physics.solar.solweig.SOLWEIGpython.Kside_veg_v2022a import Kside_veg_v2022a
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.Perez_v3 import Perez_v3
from pymdu.physics.solar.solweig.SEBESOLWEIGCommonFiles.create_patches import (
    create_patches,
)

# Anisotropic longwave
from pymdu.physics.solar.solweig.SOLWEIGpython.Lcyl_v2022a import Lcyl_v2022a
from pymdu.physics.solar.solweig.SOLWEIGpython.Lside_veg_v2022a import Lside_veg_v2022a
...
def Solweig_2022a_calc(
    ...
    #            Ldown, Lside, L_patches, CI_Tg, CI_TgG, KsideD, dRad, Kside

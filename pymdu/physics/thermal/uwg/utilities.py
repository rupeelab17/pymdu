...
def float_in_range(value, mi=INFNEG, ma=INFPOS, input_name=''):
    ...
    assert mi <= value <= ma, (
        'Input number {} must be between {} and {}. ' 'Got {}'.format(
            input_name, mi, ma, value
        )
    )
    return value
...
def float_in_range_excl(value, mi=INFNEG, ma=INFPOS, input_name=''):
    ...
    assert mi < value < ma, (
        'Input number {} must be greater than {} ' 'and less than {}. Got {}'.format(
            input_name, mi, ma, value
        )
    )
    return value
...
def float_in_range_excl_incl(value, mi=INFNEG, ma=INFPOS, input_name=''):
    ...
    assert mi < value <= ma, (
        'Input number {} must be greater than {} and less than '
...
def float_in_range_incl_excl(value, mi=INFNEG, ma=INFPOS, input_name=''):
    ...
    assert mi <= value < ma, (
        'Input number {} must be greater than or equal to {} '
...
def int_in_range(value, mi=INFNEG, ma=INFPOS, input_name=''):
    ...
    number = int(value)
    assert mi <= number <= ma, (
        'Input integer {} must be between {} and {}. ' 'Got {}.'.format(
            input_name, mi, ma, value
        )
    )
    return number

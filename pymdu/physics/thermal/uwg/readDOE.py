...
def readDOE(serialize_output=True):
    ...
    for i in range(16):
        ...
        Occupant = str2fl(
            [list_doe2[2][11], list_doe2[3][11], list_doe2[4][11]]
        )  # Number of People
        ...
        RvalWall = str2fl(
            [list_doe3[4][4:20], list_doe3[15][4:20], list_doe3[26][4:20]]
        )  # [m2*K/W] R-value
        TypeRoof = [
            list_doe3[5][4:20],
            list_doe3[16][4:20],
        ...
        RvalRoof = str2fl(
            [list_doe3[6][4:20], list_doe3[17][4:20], list_doe3[28][4:20]]
        )  # [m2*K/W] R-value
        Uwindow = str2fl(
            [list_doe3[7][4:20], list_doe3[18][4:20], list_doe3[29][4:20]]
        )  # [W/m2*K] U-factor
        SHGC = str2fl(
            [list_doe3[8][4:20], list_doe3[19][4:20], list_doe3[30][4:20]]
        )  # [-] coefficient
        HVAC = str2fl(
            [list_doe3[9][4:20], list_doe3[20][4:20], list_doe3[31][4:20]]
        )  # [kW] Air Conditioning
        HEAT = str2fl(
            [list_doe3[10][4:20], list_doe3[21][4:20], list_doe3[32][4:20]]
        )  # [kW] Heating
        COP = str2fl(
            [list_doe3[11][4:20], list_doe3[22][4:20], list_doe3[33][4:20]]
        )  # [-] Air Conditioning COP
        # [%] Heating Efficiency
        EffHeat = str2fl(
            [list_doe3[12][4:20], list_doe3[23][4:20], list_doe3[34][4:20]]
        )
        # [m3/s] Fan Max Flow Rate
        FanFlow = str2fl(
            [list_doe3[13][4:20], list_doe3[24][4:20], list_doe3[35][4:20]]
        )
        ...
        SetCool = str2fl(
            [list_doe4[10][6:30], list_doe4[11][6:30], list_doe4[12][6:30]]
        )
        ...
        for j in range(3):
            ...
            for k in range(16):
                ...
                if TypeWall[j][k] == 'MassWall':
                    ...
                    D_ins = (
                        Rins * Insulation.thermalcond
                    )  # depth of ins from m2*K/W * W/m*K = m
                    if D_ins > 0.01:
                        thickness = [
                            0.0254,
                            0.0508,
                    ...
                    wall = Element(
                        0.08, 0.92, thickness, layers, 0.0, 293.0, 0.0, 'MassWall'
                    )
                    ...
                    wall = Element(
                        0.22, 0.92, thickness, layers, 0.0, 293.0, 0.0, 'WoodFrameWall'
                    )
                    ...
                    mass = Element(
                        alb, emis, thickness, [wood, wood], 0.0, 293.0, 1.0, 'WoodFloor'
                    )
                    ...
                    wall = Element(
                        0.15, 0.92, thickness, layers, 0.0, 293.0, 0.0, 'SteelFrame'
                    )
                    ...
                    wall = Element(
                        alb, emis, thickness, materials, 0, 293, 0, 'MetalWall'
                    )
                ...
                if TypeRoof[j][k] == 'IEAD':  # Insulation Entirely Above Deck
                    ...
                    alb = 0.2
                    emis = 0.93
                    D_ins = max(RvalRoof[j][k] * Insulation.thermalcond / 2.0, 0.01)
                    roof = Element(
                        alb,
                        emis,
                        [D_ins, D_ins],

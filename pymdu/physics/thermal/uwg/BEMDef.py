...
class BEMDef(object):
    ...
    Properties:
        ...
        * T_wallex -- wall surface example (ext) [K]
        * T_wallin -- wall surface example (int) [K]
        * T_roofex -- roof surface example (ext) [K]
        * T_roofin -- roof surface example (int) [K]
    """
    ...
    def from_dict(cls, data):
        ...
        """
        assert data['type'] == 'BEMDef', (
            'Expected ' 'BEMDef dictionary. Got {}.'.format(data['type'])
        )
    ...
    def building(self, value):
        assert isinstance(value, Building), (
            'building must be a Building ' 'object. Got: {}.'.format(value)
        )
    ...
    def mass(self, value):
        assert isinstance(value, Element), (
            'mass must be an Element object. ' 'Got: {}.'.format(value)
        )
        self._mass = value
    ...
    def roof(self, value):
        assert isinstance(value, Element), (
            'roof must be an Element object. ' 'Got: {}.'.format(value)
        )
        self._roof = value
    ...
    def wall(self, value):
        assert isinstance(value, Element), (
            'wall must be an Element object. ' 'Got: {}.'.format(value)
        )
        self._wall = value
    ...
    def bldtype(self, value):
        assert isinstance(value, str), (
            'The bldtype must be a string. ' 'Got: {}.'.format(value.lower())
        )
        self._bldtype = value
    ...
    def builtera(self, value):
        assert (
            isinstance(value, str) and value in REF_BUILTERA_SET
        ), 'The builtera must be one of {}.Got: {}.'.format(REF_BUILTERA, value.lower())
